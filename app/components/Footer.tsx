      ...
      <div className=" padding-container max-container flex w-full flex-col gap-14 ">
        <div className="flex flex-col items-start justify-center gap-[10%] md:flex-row">
          <Link href='/' className='mb-10' >
            <Image src='hilink-logo.svg' alt='hilink' width={74} height={24}/>
          </Link>

          <div className="flex flex-wrap gap-10 sm:justify-between md:flex-1">
            {FOOTER_LINKS.map((columns) => (
              <FooterColumn title={columns.title}>
                <ul className='regular-14 flex flex-col gap-5 pr-7 text-gray-30 '>
        ...
        <p className='regular-14 w-full text-center text-gray-30'>2025 Hilink | rights reserved</p>
      </div>
